    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                String name= getContactName( number, WhatsappHome.this);
                int videoCall=getContactIdForWhatsAppVideoCall(name,WhatsappHome.this);
                if (videoCall!=0)
                {
        ...
        audioCall.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                String number = phoneNumber.getText().toString();
                String name= getContactName(number , WhatsappHome.this);
                int whatsappcall=getContactIdForWhatsAppCall(name,WhatsappHome.this);
                if (whatsappcall!=0) {
